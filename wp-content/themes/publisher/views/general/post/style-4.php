...
switch ( $layout ) {
	case '2-col-right':
		$container_class = 'container layout-2-col layout-right-sidebar post-template-4';
		$main_col_class  = 'col-sm-8 content-column';
		$aside_col_class = 'col-sm-4 sidebar-column';
		break;

	case '2-col-left':
		$container_class = 'container layout-2-col layout-left-sidebar post-template-4';
		$main_col_class  = 'col-sm-8 col-sm-push-4 content-column';
		$aside_col_class = 'col-sm-4 col-sm-pull-8 sidebar-column';
		break;

	case '1-col':
		$container_class = 'container layout-1-col layout-no-sidebar post-template-4';
...
<div class="post-header post-tp-4-header" style="background-image: url(<?php echo esc_url( $img['src'] ); ?>);">
