		...
		<div class="table">
			...
			<div class="row">
	    		...
	    		<div class="cell textalignleft">
		    		...
		    		<input type="text" name="setting[sendy][code]" value="<?php echo $data['module']->setting['code']; ?>" size="40" />
	  		...
	  		<div class="row">
	    		...
	    		<div class="cell textalignleft">
		    		...
		    		<input type="text" name="setting[sendy][list_id]" value="<?php echo $data['module']->setting['list_id']; ?>" size="40" />
	  		...
	  		<div class="row">
	    		...
	    		<div class="cell textalignleft">
					...
					<input type="text" name="setting[sendy][post_url]" value="<?php echo $data['module']->setting['post_url']; ?>"  size="40"/>

					<div class="tips width100">

						<?php _e('Url to Sendy arp3-formcapture.pl file','mgm'); ?><br/>
