						...
						<footer class="bs-pages-plugin-item-footer">
							...
							<div class="bs-pages-plugin-item-footer-wrapper">
								...
								<span class="install-plugin">
									<a href="#"
									   class="bs-pages-primary-btn"><?php esc_html_e( 'Install', 'publisher' ) ?></a>
								</span>
								<span class="update-plugin">
									<a href="#"
									   class="bs-pages-primary-btn"><?php esc_html_e( 'Update plugin', 'publisher' ) ?></a>
								</span>
								<span class="active-plugin">
									<a href="#"
									   class="bs-pages-primary-btn"><?php esc_html_e( 'Activate', 'publisher' ) ?></a>
								</span>
								<span class="deactivate-plugin">
									<span class="success-message">
										<?php esc_html_e( 'Active plugin', 'publisher' ); ?>
									</span>
									<a href="#"
									   class="bs-pages-secondary-btn"><?php esc_html_e( 'Deactivate', 'publisher' ) ?></a>
								</span>
									</div>
								...
								<?php else: ?>
									<span
										class="active-error"><?php echo wp_kses( printf( __( 'Please register your %s', 'publisher' ), $product_type ), bf_trans_allowed_html() ); ?></span>
								<?php endif ?>
							</div>
						</footer>
					</div>
