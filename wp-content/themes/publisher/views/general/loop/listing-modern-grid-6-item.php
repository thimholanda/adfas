...
?>
<article <?php publisher_attr( 'post', publisher_get_prop_class() . ' listing-item listing-mg-item listing-mg-6-item ' . $main_term_class ) ?>>
		...
		<div class="content-container">
			<h2 class="title">
				<a class="post-url" itemprop="url" rel="bookmark" href="<?php the_permalink(); ?>">
					<span <?php publisher_attr( 'post-title' ); ?>><?php publisher_echo_html_limit_words( get_the_title(), publisher_get_prop( 'title-limit', 140 ) ); ?></span>
				</a>
			</h2>
			<?php
