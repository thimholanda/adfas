...
class BF_Product_Demo_Manager extends BF_Product_Multi_Step_Item {
							...
							<div class="bs-pages-buttons" data-demo-id="<?php echo esc_attr( $demo_id ) ?>">
								...
								<span class="preview-demo">
									<a href="<?php echo esc_url( $demo_data['preview_url'] ); ?>" target="_blank"
									   class="bs-pages-secondary-btn"><?php esc_html_e( 'Preview', 'publisher' ) ?></a>
								</span>
								<span class="uninstall-demo highlight-section">
									<a href="#"
									   class="bs-pages-secondary-btn"><?php esc_html_e( 'Uninstall', 'publisher' ) ?></a>
								</span>
							</div>
							<div class="messages">
								...
								<div class="failed">
									<?php esc_html_e( 'process canceled', 'publisher' ) ?>
								</div>
							</div>
						</footer>
					</div>
	...
	public function calc_media_per_step() {
		...
		$is_memory_enough = wp_is_ini_value_changeable( 'memory_limit' ) ||
		                    wp_convert_hr_to_bytes( WP_MEMORY_LIMIT ) < 67108864; // 64MB
