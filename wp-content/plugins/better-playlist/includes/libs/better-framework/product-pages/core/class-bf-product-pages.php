...
class BF_Product_Pages extends BF_Product_Pages_Base {
	...
	public function init() {
		...
		//		add_filter( 'better-framework/product-pages/setup', array( $this, 'auto_setup_theme_props' ), 5 );
		//		add_filter( 'better-framework/product-pages/admin-menus/setup', array( $this, 'setup_admin_menus' ), 5 );
