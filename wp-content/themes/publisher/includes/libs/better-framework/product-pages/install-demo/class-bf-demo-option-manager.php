		...
		if ( isset( $option_params['option_value'] ) ) {
			...
			if( is_array( $option_params['option_value'] ) ){
				foreach ( $option_params['option_value'] as $id => $val ){
					$option_params['option_value'][$id] = BF_Product_Demo_Factory::Run()->apply_pattern( $val );
				}
			}else{
				$option_params['option_value'] = BF_Product_Demo_Factory::Run()->apply_pattern( $option_params['option_value'] );
			}

			return $option_params['option_value'];
		}

		return BF_Product_Demo_Factory::Run()->apply_pattern( $option_params );
	}
