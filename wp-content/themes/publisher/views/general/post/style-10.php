...
switch ( $layout ) {
	case '2-col-right':
		$container_class = 'container layout-2-col layout-right-sidebar post-template-10';
	...
	case '2-col-left':
		$container_class = 'container layout-2-col layout-left-sidebar post-template-10';
	...
	case '1-col':
		$container_class = 'container layout-1-col layout-no-sidebar post-template-10';
