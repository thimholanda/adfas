...
<article <?php publisher_attr( 'post', publisher_get_prop_class() . ' clearfix listing-item listing-item-tall listing-item-tall-2 ' . $main_term_class ); ?>>
	...
	<?php if ( publisher_has_post_thumbnail() ) { ?>
		<div class="featured clearfix">
			...
			<?php $img = publisher_get_thumbnail( publisher_get_prop_thumbnail_size( 'publisher-tall-big' ) ); ?>
	...
	<h2 class="title">
		<a <?php publisher_attr( 'post-url' ); ?>><span <?php publisher_attr( 'post-title' ); ?>><?php publisher_echo_html_limit_words( get_the_title(), 56 ); ?></span></a>
	</h2>
