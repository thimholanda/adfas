...
<div class="wc-account-content-wrap">
	...
	<form class="woocommerce-EditAccountForm edit-account" action="" method="post">
		...
		<h3 class="section-heading"><span
				class="h-text"><?php esc_html_e( 'Your Information', 'publisher' ); ?></span></h3>

		<?php do_action( 'woocommerce_edit_account_form_start' ); ?>

		<p class="woocommerce-FormRow woocommerce-FormRow--first form-row form-row-first">
			<label for="account_first_name"><?php esc_html_e( 'First name', 'publisher' ); ?> <span
		...
		<p class="woocommerce-FormRow woocommerce-FormRow--last form-row form-row-last">
			<label for="account_last_name"><?php esc_html_e( 'Last name', 'publisher' ); ?> <span
					class="required">*</span></label>
		...
		<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
			<label for="account_email"><?php esc_html_e( 'Email address', 'publisher' ); ?> <span
					class="required">*</span></label>
		...
		<fieldset>
			<legend><?php esc_html_e( 'Password Change', 'publisher' ); ?></legend>

			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				<label
					for="password_current"><?php esc_html_e( 'Current Password (leave blank to leave unchanged)', 'publisher' ); ?></label>
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				<label
					for="password_1"><?php esc_html_e( 'New Password (leave blank to leave unchanged)', 'publisher' ); ?></label>
				<input type="password" class="woocommerce-Input woocommerce-Input--password input-text"
				       name="password_1" id="password_1"/>
			</p>
			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				<label for="password_2"><?php esc_html_e( 'Confirm New Password', 'publisher' ); ?></label>
				<input type="password" class="woocommerce-Input woocommerce-Input--password input-text"
		...
		<p>
			...
			<input type="submit" class="woocommerce-Button button" name="save_account_details"
			       value="<?php esc_attr_e( 'Save changes', 'publisher' ); ?>"/>
