...
switch ( $layout ) {
	case '2-col-right':
		$container_class = 'container layout-2-col layout-right-sidebar post-template-11';
		$main_col_class  = 'col-sm-8 content-column';
		$aside_col_class = 'col-sm-4 sidebar-column';
		$img_size        = 'publisher-lg';
		break;

	case '2-col-left':
		$container_class = 'container layout-2-col layout-left-sidebar post-template-11';
	...
	case '1-col':
		$container_class = 'container layout-1-col layout-no-sidebar post-template-11';
		$main_col_class  = 'col-sm-12 content-column';
		$aside_col_class = '';
		$img_size        = 'publisher-full';
		break;
}

the_post();

$img = publisher_get_thumbnail( publisher_get_prop_thumbnail_size( $img_size ) );
