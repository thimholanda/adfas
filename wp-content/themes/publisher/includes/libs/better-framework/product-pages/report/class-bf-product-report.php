		...
		switch ( $box['box-settings']['operation'] ) {
			...
			case 'report-export':
				...
				if ( $this->render_context === 'html' ) {
					...
					$box['items'][] = array(
						'type'        => 'raw',
						'label'       => sprintf( '<a href="#" class="bs-pages-primary-btn bs-pages-success-btn" id="bs-get-system-report"><span class="loading" style="display: none;margin: 0 5px;"><i class="fa fa-refresh fa-spin"></i></span> %s</a>', __( 'Get Status Report', 'publisher' ) ),
					...
					$box['items'][] = array(
						...
						'label'       => FALSE,
						'class'       => 'bs-item-hide',
						'description' => '<div id="bs-system-container" style="display: none;"><textarea rows="20" style="width: 100%;color: #595959;" class="bs-output">' . $this->render_text() . '</textarea><a href="#" class="bs-pages-primary-btn" id="bs-copy-system-report">' . __( 'Copy status report', 'publisher' ) . '</a></div>'
					);
				}
