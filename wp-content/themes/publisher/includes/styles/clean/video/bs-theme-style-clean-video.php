 ...
 *          -> Video Demo
 */
class Publisher_Theme_Style_Clean_Video extends Publisher_Theme_Style_Clean {
	...
	function register_assets() {
		...
		wp_enqueue_style(
			...
			Publisher_Theme_Styles_Manager::get_uri( 'clean/video/style.css' ),
			array( 'publisher' ),
	...
	function customize_panel_fields() {
		...
		Publisher_Theme_Panel_Fields::$fields['topbar_text_color'][ $std_id ]       = '#9c9c9c';
		Publisher_Theme_Panel_Fields::$fields['topbar_text_hcolor'][ $std_id ]      = '';
		Publisher_Theme_Panel_Fields::$fields['topbar_bg_color'][ $std_id ]         = '#2b2b2b';
		Publisher_Theme_Panel_Fields::$fields['topbar_border_color'][ $std_id ]     = '#1d1d1d';
		...
		Publisher_Theme_Panel_Fields::$fields['topbar_icon_bg'][ $std_id ]          = '#e62929';
		Publisher_Theme_Panel_Fields::$fields['topbar_icon_bg_hover'][ $std_id ]    = '#d61a1a';


		/**
		 * -> Header Colors
		 */
		Publisher_Theme_Panel_Fields::$fields['header_menu_bg_color'][ $std_id ]          = '#2f2f2f';
		...
		Publisher_Theme_Panel_Fields::$fields['header_bg_color'][ $std_id ]               = '#2f2f2f';
		Publisher_Theme_Panel_Fields::$fields['header_menu_btop_color'][ $std_id ]        = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st1_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st2_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st3_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st4_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st5_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st6_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st7_bbottom_color'][ $std_id ] = '#232323';
		Publisher_Theme_Panel_Fields::$fields['header_menu_st8_bbottom_color'][ $std_id ] = '#232323';
		...
		Publisher_Theme_Panel_Fields::$fields['cat_topposts_bg_color'][ $std_id ]         = '#292929';
		...
		Publisher_Theme_Panel_Fields::$fields['widget_title_bg_color'][ $std_id ]  = '#2d2d2d';
		 ...
		 * -> Posts
		 **/
		Publisher_Theme_Panel_Fields::$fields['post_template'][ $std_id ] = 'style-12';
		...
		Publisher_Theme_Panel_Fields::$fields['header_style'][ $std_id ]  = 'style-5';
